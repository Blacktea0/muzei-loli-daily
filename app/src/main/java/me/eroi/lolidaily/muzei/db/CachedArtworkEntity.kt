 ...
 *
 * Complex fields are stored as JSON strings via [Converters] to keep the schema
 * migration-free — adding a field to the upstream Card/SuggestedBy model does not
