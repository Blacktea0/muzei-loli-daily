...
/**
 * Response from the Loli Daily reactions API.
 * Example: GET https://loliconey.tsuki.ga/api/v1/daily/react?badge=LC%20YJ-ES-NC-PG
 */
@Serializable
data class DailyReactResponse(
    /**
     * Per-card reaction maps. Each element is a map of:
     *   emoji value (string key) → list of [username, nickname] pairs.
     * Empty maps indicate no reactions for that card.
     */
